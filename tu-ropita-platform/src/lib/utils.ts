...
import { IBrandCreditsDto } from "./backend/dtos/credit.dto.interface";
...
export async function getBrandCreditsDtoFromBody(req: Request) : Promise<IBrandCreditsDto>{
  return getDtoFromBody<IBrandCreditsDto>(req, ['add_credits']);
}
